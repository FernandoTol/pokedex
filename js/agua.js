const pokemones = [7,8,9,54,55,60,61,62,72,73,79,80,86,87,90,91,98,99,116,117,118,119,120,121,129,130,131,134,138,139,140,141]
...
for (let i = 0; i < pokemones.length; i++) {
    ...
    const fetchApi = async () => {
        try {
            ...
            console.log('numero poke' + pokemones.length)
            console.log('numeros: ' + pokemones[i])
